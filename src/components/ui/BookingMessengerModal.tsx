		...
		>
			<div className="px-5 py-5 sm:px-7 sm:py-7">
				<div className="flex items-start justify-between gap-3">
					<h2 className="text-2xl leading-tight font-semibold text-stone-800">
						Gửi nội dung booking
					</h2>
					<button
						onClick={onClose}
						aria-label="Đóng modal"
						className="h-11 w-11 shrink-0 rounded-full border-2 border-[#d19135] text-[#91622c] flex items-center justify-center hover:bg-[#fff7eb] transition-colors"
					>
						<X className="h-5 w-5" />
					</button>
				</div>

				<div className="mt-5 rounded-2xl border border-[#e8cfaa] bg-[#fff8ef] px-4 py-3 sm:px-5 sm:py-4 flex items-start gap-3 text-stone-700">
				...
				<div className="mt-4 rounded-2xl bg-[#f4f0ea] px-4 py-5 sm:px-5">
					<p className="text-base leading-8 text-stone-700 wrap-break-words">
						{bookingMessage}
					</p>
				</div>
				...
				<div className="mt-4 flex flex-wrap items-center justify-between gap-3">
					...
					<button
						...
						className="rounded-xl border border-[#e5d2b6] bg-white px-4 py-2 text-base font-medium text-stone-600 hover:bg-stone-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
					>
				...
				<div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
					<button
						...
						className="h-12 rounded-xl bg-[#d77d46] text-white font-semibold text-lg hover:opacity-95 transition-opacity flex items-center justify-center gap-2"
					>
					...
					<button
						...
						className="h-12 rounded-xl bg-[#e6f2ee] text-[#196b4f] font-semibold text-lg hover:bg-[#dcebe6] transition-colors flex items-center justify-center gap-2"
					>
				...
				<div className="mt-5 flex justify-center">
					<button
						onClick={onClose}
						className="px-4 py-2 text-lg font-semibold text-stone-500 hover:text-stone-700 transition-colors"
					>
						Đóng
					</button>
				</div>
